  ...
  return (
    ...
    >
      <div className="text-standard text-sm mobile:text-base">
        {/* Hero */}
        <header className="relative container max-desktop:px-page pt-16 mobile:pt-20 desktop:pt-28 pb-16 mobile:pb-20 desktop:pb-28">
          ...
          <div className={styles.hero}>
            <div className="flex flex-col gap-6">
              <h1 className="text-hero leading-tight text-start">
        ...
        <div className="relative container max-desktop:px-page pb-64 space-y-48">
          <FxEdgeInnerLightEffect
            position="top"
            className="w-[150%] min-w-[960px] h-[600px] left-1/2 -translate-x-1/2 top-0 opacity-50 mix-blend-screen"
            aria-hidden="true"
          />
          ...
          <section aria-labelledby="why-it-matters">
            <div className="flex items-center gap-3 mb-12">
              <span className="inline-block h-px w-8 bg-[rgb(var(--ragflow-color-primary))]" />
            ...
            <div className={cn(styles.howItWorks, styles.flowPlaceholder)}>
              <header className="absolute top-6 left-6 z-10">
                ...
                <p className="text-secondary text-sm leading-relaxed max-w-3xl">
                  The Knowledge Compilation Engine applies semantic templates to transform parsed documents into
                  structured knowledge artifacts, which are then indexed to power AI agents.
                </p>
              </header>

              <div className={cn(styles.flowSteps, "mt-24")}>
          ...
          <section aria-labelledby="see-in-action" className="space-y-8">
